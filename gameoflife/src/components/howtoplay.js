        ...
        return (
            <div className="howtoplay">
                <div className="rules">
                    ...
                    <br /> <br />
                    <span>In order to play, you can either click into a box to turn it on and or use any of the presets above and click play! The play button will turn the algorithm on, and based on the rules below you will be able to see the lifecycle of the boxes The rules are as follows:<br /> <br /></span>
